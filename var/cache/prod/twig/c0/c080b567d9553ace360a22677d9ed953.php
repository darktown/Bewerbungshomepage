...
class __TwigTemplate_6f8ce62b87ec6ecea0f3f4243945d1d7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["ea"] ?? null), "crud", [], "any", false, false, false, 4), "currentAction", [], "any", false, false, false, 4) == "detail")) {
            // line 5
            echo "    ";
            echo twig_nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["field"] ?? null), "formattedValue", [], "any", false, false, false, 5), "html", null, true));
            echo "
";
        } else {
            // line 7
        ...
        <div class=\"modal-dialog modal-lg\" role=\"document\">
            ...
            echo "\">
                ...
                <div class=\"modal-body\">
                    ";
            // line 21
            echo twig_nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["field"] ?? null), "formattedValue", [], "any", false, false, false, 21), "html", null, true));
            echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return new Source("", "@EasyAdmin/crud/field/text_editor.html.twig", "C:\\wamp64\\www\\rene\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\text_editor.html.twig");
    }
}
