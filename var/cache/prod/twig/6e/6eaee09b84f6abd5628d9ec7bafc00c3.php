...
class __TwigTemplate_0637484c8b4c54deaf1de0d21017bfa7 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <script>
        ...
        if (($context["relative_path"] ?? null)) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 31), "schemeAndHttpHost", [], "any", false, false, false, 31), "html", null, true);
...
";
    ...
    {
        return array (  94 => 35,  90 => 33,  82 => 31,  80 => 30,  75 => 28,  71 => 27,  67 => 26,  45 => 7,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@FMElfinder/Elfinder/tinymce4.html.twig", "C:\\wamp64\\www\\rene\\vendor\\helios-ag\\fm-elfinder-bundle\\src\\Resources\\views\\Elfinder\\tinymce4.html.twig");
    }
}
