 ...
 */
class Texte extends \App\Entity\Texte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Texte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Texte' . "\0" . 'section', '' . "\0" . 'App\\Entity\\Texte' . "\0" . 'text'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Texte $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSection(string $section): \App\Entity\Texte
    {
     ...
     * {@inheritDoc}
     */
    public function setText(string $text): \App\Entity\Texte
    {
