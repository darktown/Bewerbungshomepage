...
class __TwigTemplate_3dddfaceed150131704f3f83a9cebd81 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <input type=\"checkbox\" class=\"form-check-input\" id=\"";
            ...
            data-toggle-url=\"";
            // line 13
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 13, $this->source); })()), "customOptions", [], "any", false, false, false, 13), "get", ["toggleUrl"], "method", false, false, false, 13), "html", null, true);
            echo "\"
            ";
            // line 14
            echo (((twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 14, $this->source); })()), "formTypeOption", ["disabled"], "method", false, false, false, 14) == true)) ? ("disabled") : (""));
...
{% endif %}
", "@EasyAdmin/crud/field/boolean.html.twig", "C:\\wamp64\\www\\rene\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\boolean.html.twig");
    }
}
