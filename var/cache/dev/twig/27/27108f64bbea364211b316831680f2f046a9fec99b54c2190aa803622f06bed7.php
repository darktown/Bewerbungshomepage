...
class __TwigTemplate_b1d4961489804b5c1493d01b0d75f566ef605638a6f85ecdbd77112a92147338 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  92 => 8,  88 => 7,  84 => 6,  80 => 5,  76 => 4,  68 => 3,  59 => 2,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'base.html.twig' %} {% block css %}
{{ parent() }}
{% endblock %} {% block body %} {# {% include \"/head/index.html.twig\" %} #}
{{ parent() }}
{{ render(\"head\") }}
{{ render(\"about\") }}
{{ render(\"skills\") }}
{{ render(\"csv\") }}
{% endblock %}
", "home/index.html.twig", "C:\\MAMP\\htdocs\\rene\\templates\\home\\index.html.twig");
    }
}
