...
class __TwigTemplate_0f35d647db5250560ca475fa6a728b63 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  128 => 26,  109 => 21,  104 => 19,  100 => 18,  95 => 16,  86 => 14,  83 => 13,  66 => 12,  54 => 2,  41 => 1,);
    }
              ...
              <div class=\"carousel-inner\">
                ...
                <!-- ifabfrage ob index = 0 ist, wenn ja wird beim ersten aufruf active beim ersten item gesetzt  -->
                  <div {% if loop.index0 == 0 %} class=\"carousel-item active\" {% else %} class=\"carousel-item\" {% endif %}>
                    ...
                    <a class=\"btn-outline-lg page-scroll\" href=\"{{ path('impressum') }}\">
                      <i class=\"fas fa-user\"></i>Contact Me
                    </a>
                  </div>
                {% endfor %}
