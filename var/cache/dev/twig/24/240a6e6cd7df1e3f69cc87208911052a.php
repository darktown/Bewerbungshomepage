...
class __TwigTemplate_35580b5a965cd07c83fcf03f587a4597 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_5"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "C:\\wamp64\\www\\rene\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
