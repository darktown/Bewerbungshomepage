 ...
 */
class getProjekteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjekteRepository' shared autowired service.
     *
     * @return \App\Repository\ProjekteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjekteRepository.php';

        return $container->privates['App\\Repository\\ProjekteRepository'] = new \App\Repository\ProjekteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
